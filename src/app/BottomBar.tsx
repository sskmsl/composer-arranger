...
export function BottomBar() {
  ...
  return (
    <footer className="relative flex h-14 shrink-0 items-center gap-2 border-t border-hairline bg-surface-tile-3 px-3">
      ...
      {historyOpen && (
        <div className="absolute bottom-14 right-3 max-h-72 w-80 overflow-y-auto rounded-lg border border-hairline bg-surface-tile-1 p-2 shadow-[3px_5px_30px_rgba(0,0,0,0.4)]">
